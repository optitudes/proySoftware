...
/**
 * This is the item provider adapter for a {@link interrapidisimo.domain.FactoryGestionHumana} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FactoryGestionHumanaItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.FACTORY_GESTION_HUMANA__LST_CLIENTE);
			childrenFeatures.add(DomainPackage.Literals.FACTORY_GESTION_HUMANA__LST_EMPLEADO);
			childrenFeatures.add(DomainPackage.Literals.FACTORY_GESTION_HUMANA__LST_TRANSPORTADOR);
		}
	...
	public String getText(Object object) {
		return getString("_UI_FactoryGestionHumana_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.FACTORY_GESTION_HUMANA__LST_CLIENTE,
				 DomainFactory.eINSTANCE.createCliente()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.FACTORY_GESTION_HUMANA__LST_EMPLEADO,
				 DomainFactory.eINSTANCE.createEmpleado()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.FACTORY_GESTION_HUMANA__LST_TRANSPORTADOR,
				 DomainFactory.eINSTANCE.createTransportador()));
	}
