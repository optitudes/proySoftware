...
/**
 * This is the item provider adapter for a {@link interrapidisimo.domain.Domain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.DOMAIN__OWNED_BY_FACTORY_BODEGA);
			childrenFeatures.add(DomainPackage.Literals.DOMAIN__THE_FACTORY_GESTION_HUMANA);
			childrenFeatures.add(DomainPackage.Literals.DOMAIN__LST_FACTORY_PAGO);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.DOMAIN__OWNED_BY_FACTORY_BODEGA,
				 DomainFactory.eINSTANCE.createFactoryBodega()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.DOMAIN__THE_FACTORY_GESTION_HUMANA,
				 DomainFactory.eINSTANCE.createFactoryGestionHumana()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.DOMAIN__LST_FACTORY_PAGO,
				 DomainFactory.eINSTANCE.createFactoryPago()));
	}
